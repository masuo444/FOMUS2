...
export declare namespace compute_beta {
    ...
    export interface Schema$Project {
        ...
        kind?: string | null;
        /**
         * [Output Only] The Cloud Armor Managed Protection (CAMP) tier for this project. It can be one of the following values: CA_STANDARD, CAMP_PLUS_MONTHLY. If this field is not specified, it is assumed to be CA_STANDARD.
         */
    ...
    export interface Schema$RegionNetworkFirewallPo